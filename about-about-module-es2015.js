...
let AboutPage = class AboutPage {
    ...
    ngOnInit() {
        this.edu = [
            { name: 'Under Graduate', desc: 'I\'m currently pursuing my B.Tech in IIT Madras ', imgUrl: '/assets/Picss/1.png' },
            { name: 'Primary and Secondary education', desc: 'At R S Krishnan Higher Secondary School', imgUrl: '/assets/Picss/2.jpg' },
            { name: 'Higher Secondary education', desc: 'At Maharishi International Residential School', imgUrl: '/assets/Picss/2.jpg' }
        ];
    }
};
