...
let HomePage = class HomePage {
    ...
    ngOnInit() {
        this.nopages = [
            { name: 'Blog', desc: 'A few thoughts put into words', imgUrl: '/assets/Pics/9.jpg', Url: 'blog' },
            { name: 'Photography', desc: 'Captured, not what I saw, but what I felt', imgUrl: '/assets/Pics/2.jpg', Url: 'photo' },
            { name: 'About', desc: 'An insight into me', imgUrl: '/assets/Pics/6.jpg', Url: 'about' }
        ];
    }
};
